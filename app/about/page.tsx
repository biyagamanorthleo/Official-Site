    ...
    <div className="bg-black pt-56 pb-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
                  ...
                  >
                    ...
                    <div className="md:w-1/2 flex justify-center">
                      <div className="relative group p-3 bg-black border border-white/10 rounded-[2.5rem] transition-all duration-700 shadow-3xl hover:border-red-500/40">
                        <img
                          src={pres.photo}
                          className="w-56 h-56 md:w-72 md:h-72 object-cover rounded-[2rem] grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000"
                          alt={pres.name}
                        />
                    ...
                    <div className={`md:w-1/2 mt-16 md:mt-0 ${idx % 2 === 0 ? 'md:pl-24 text-center md:text-left' : 'md:pr-24 text-center md:text-right'}`}>
                      ...
                      <p className="text-gray-500 text-xs max-w-sm mx-auto md:mx-0 leading-relaxed font-medium uppercase tracking-widest">
                        {pres.description}
                      </p>
                    </div>
                  </motion.div>
        ...
        <section className="py-40 text-center">
          ...
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed uppercase tracking-[0.2em] font-black text-xs">
            {ABOUT_CONTENT.footerText}
          </p>
        </section>
      </div>
    </div>
