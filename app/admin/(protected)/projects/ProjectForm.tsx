...
export default function ProjectForm({ project }: { project?: Project }) {
  ...
  return (
    <form onSubmit={handleSave} className="space-y-6 max-w-2xl">
      ...
      <div>
        <label className="text-[10px] font-black uppercase tracking-widest text-ink-muted block mb-2">Short Description</label>
      ...
      <div>
        <label className="text-[10px] font-black uppercase tracking-widest text-ink-muted block mb-2">Full Description</label>
      ...
      <div className="flex items-center justify-between p-5 bg-black border border-white/10 rounded-xl">
        <div>
          ...
          <p className="text-ink-muted text-[11px] mt-1">Show this project in the landing page carousel</p>
        </div>
        <button
          type="button"
