  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-10">
        ...
        <p className="text-ink-muted text-xs font-bold uppercase tracking-widest mt-1">Member Resources</p>
      </div>
      ...
      <div className="py-24 text-center border border-dashed border-white/5 rounded-3xl">
        ...
        <p className="text-ink-muted text-xs font-black uppercase tracking-widest">Content coming soon</p>
      </div>
    </div>
  );
}
